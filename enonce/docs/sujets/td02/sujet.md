...
2. Corriger le problème avec des mutex.
3. Corriger le problème avec des channels.
...
Créer 2 versions des fonctions suivantes (une normale et une concurrente) sur des tableaux d'entier.
